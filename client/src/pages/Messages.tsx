    ...
    if (userNameParam) {
      ...
      if (selectedUserNameRef.current !== userNameParam.toLowerCase()) {
        ...
        if (conversation) {
          ...
          // Conversations loaded but user not found
          navigate("/messages");
        }
        // If conversations haven't finished loading, wait for next render
      }
    }
  }, [userNameParam, conversations, selectConversation, navigate]);
